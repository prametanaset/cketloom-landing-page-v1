  ...
  ({
    ...
    return (
      <>
        <div
          className={cn(
            "pointer-events-none absolute -inset-px hidden rounded-[inherit] border border-white/5 opacity-0 transition-opacity",
            glow && "opacity-100",
        ...
        >
          <div
            className={cn(
              ...
              "after:opacity-[calc(var(--active)*0.5)] after:transition-opacity after:duration-300",
