...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/mono-1.png", alt: "E-invoicing platform overview" },
    { src: "/images/mono-2.png", alt: "API integration dashboard" },
    { src: "/images/mono-3.png", alt: "Document generation workflow" },
    { src: "/images/mono-4.png", alt: "Compliance monitoring panel" },
  ];
